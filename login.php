...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $username_err = "<font color='red'>Írd be a felhasználóneved!";
    } else{
    ...
    if(empty(trim($_POST["password"]))){
        $password_err = "<font color='red'>Írd be a jelszavadat!";
    } else{
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $login_err = "<font color='red'>Helytelen felhasználónév vagy jelszó!";
                        }
                    }
                } else{
...
<body>
    ...
    <div class="wrapper">
        <h2>Bejelentkezés</h2>
        <p>Töltsd ki a bejelentkezéshez!</p>
